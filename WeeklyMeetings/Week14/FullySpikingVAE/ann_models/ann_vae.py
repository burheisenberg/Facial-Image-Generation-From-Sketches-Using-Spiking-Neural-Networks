...
class VanillaVAE(nn.Module):
    def __init__(self) -> None:
        ...
        self.fc_mu = nn.Linear(hidden_dims[-1]*lowered_size**2, latent_dim)
        self.fc_var = nn.Linear(hidden_dims[-1]*lowered_size**2, latent_dim)
        ...
        self.final_layer = nn.Sequential(
                            ...
                            nn.LeakyReLU(),
                            nn.ConvTranspose2d(hidden_dims[-1], out_channels= self.out_channels, # deconvにしてみる
    ...
    def loss_function_kld(self,
        ...
        loss = recons_loss + 1e-8 * kld_loss
        """
...
class VanillaVAELarge(VanillaVAE):
    def __init__(self) -> None:
        ...
        self.encoder = nn.Sequential(*modules)
        self.fc_mu = nn.Linear(hidden_dims[-1]*self.lowered_size**2, latent_dim)
        self.fc_var = nn.Linear(hidden_dims[-1]*self.lowered_size**2, latent_dim)
